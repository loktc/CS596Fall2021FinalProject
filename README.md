...
4. Compare of accuracy for training 12 Epoches. Our model is quite accuracy for training samll amout of data, but there might have some overfitting problems. For larger dataset we may need to change some configuration to achieve a better result, but it is still promising. <img src="trainingAccu.png" alt="" style="width:90%">
